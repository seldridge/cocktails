...
\usepackage{graphicx}
\usepackage{multicol,array,rotating,parcolumns}
\input cocktails.sty
\graphicspath{ {./images/} }

\begin{document}
\begin{parcolumns}[colwidths={1=0.01\textwidth, 2=0.495\textwidth, 3=0.495\textwidth}]{3}
  %
  \colchunk[1]{\begin{sideways}GIN\end{sideways}}
  \colchunk[2]{\begin{tabular}{p{0.3\textwidth} p{0.99\textwidth}}
      \multicolumn{2}{p{0.495\textwidth}}{\centering\Large\textsc{20th Century}} \\ 
  ...
  \end{tabular}}
  \colchunk[3]{ \begin{tabular}{p{0.35\textwidth} p{0.99\textwidth}}
      \multicolumn{2}{p{0.495\textwidth}}{\centering\Large\textsc{Albert Mathieu}} \\ 
...
\end{tabular}}
  \colchunk[3]{\begin{tabular}{p{0.35\textwidth} p{0.99\textwidth}}
\multicolumn{2}{p{5in}}{\Large\textsc{Corpse Reviver No.400}}\\ 
...
\end{tabular}}
  \colplacechunks
%
  \colchunk[1]{\begin{sideways}BRANDY\end{sideways}}
  \colchunk[2]{\begin{tabular}{p{0.3\textwidth} p{0.99\textwidth}}
...
\end{tabular}}
  \colplacechunks
%
  \colchunk[1]{\begin{sideways}WHISKEY\end{sideways}}
  \colchunk[2]{\begin{tabular}{p{0.3\textwidth} p{0.99\textwidth}}
...
\end{tabular}}
  \colchunk[3]{\begin{tabular}{p{0.35\textwidth} p{0.99\textwidth}}
\multicolumn{2}{p{3in}}{\centering\Large\textsc{That's Why They Call Me Whiskey}} \\ 
...
\end{tabular}}
  \colchunk[3]{\begin{tabular}{p{0.35\textwidth} p{0.99\textwidth}}
\multicolumn{2}{p{3in}}{\centering\Large\textsc{Triple Crown and Travers Too}} \\ 
...
\end{tabular}}
  \colplacechunks
%
  \colchunk[1]{\begin{sideways}TEQUILA\end{sideways}}
  \colchunk[2]{\begin{tabular}{p{0.3\textwidth} p{0.99\textwidth}}
...
\end{tabular}}
  \colchunk[3]{\begin{tabular}{p{0.35\textwidth} p{0.99\textwidth}}
\multicolumn{2}{p{3in}}{\centering\Large\textsc{Please Don't Tell Paddington}} \\ 
...
\end{tabular}}
  \colplacechunks
%
  \colchunk[1]{\begin{sideways}TRIAL DRINKS\end{sideways}}
  \colchunk[2]{\begin{tabular}{p{0.3\textwidth} p{0.99\textwidth}}
